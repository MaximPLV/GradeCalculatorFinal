...
public class ImageDataExtractorObj {

    private String imageContent;

    public ImageDataExtractorObj(BufferedImage imageFile) {
        this.imageContent = getString(imageFile);
    }
    public static String getString(BufferedImage imageFile) {
        try {
    ...
    public static String extractGradeAmounts(BufferedImage imageFile) {
        String data = getString(imageFile);
    ...
    public static String extractAverageGrade(BufferedImage imageFile) {
        String data = getString(imageFile);
    ...
    public static BufferedImage preprocessImage(BufferedImage originalImage, boolean process) {
